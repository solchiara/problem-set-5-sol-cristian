...
print(f"Total number of actions since January 2023: {len(df_2021)}")
print("Earliest action details:", df_2021.iloc[-1])
```
...
df_enforcement_subset = df_enforcement_subset.groupby("Category").
